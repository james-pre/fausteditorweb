  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [
        ...
        { from: './node_modules/@shren/kissfft-js/libkissfft-wasm/libkissfft.*', to: './kissfftwasm/[name][ext]' },
        { from: './node_modules/@shren/kissfft-js/dist/cjs-bundle/index.*', to: './kissfftwasm/cjs-bundle/[name][ext]' },
