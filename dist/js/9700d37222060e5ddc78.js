      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", faust.fs().readFile("/usr/share/faust/" + fileName, {
              encoding: "utf8"
            }));
                ...
                if (matched) {
                  ...
                  return {
                    ...
                    contents: [{
                      ...
                      value: prefix.length ? "[Detail...](".concat(_documentation__WEBPACK_IMPORTED_MODULE_5__["faustDocURL"], "/").concat(_documentation__WEBPACK_IMPORTED_MODULE_5__["docSections"][prefix.slice(0, 2).toString()], "/#").concat(prefix.join(".")).concat(doc.name.replace(/[[\]|]/g, "").toLowerCase(), ")") : "[Detail...](https://faustdoc.grame.fr/manual/syntax/index.html#faust-syntax)"
                    }]
                  };
                }
...
//# sourceMappingURL=9700d37222060e5ddc78.js.map